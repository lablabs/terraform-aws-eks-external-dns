...
| <a name="input_argocd_application"></a> [argocd\_application](#input\_argocd\_application) | If set to true, the module will be deployed as ArgoCD application, otherwise it will be deployed as a Helm release | `bool` | `false` | no |
